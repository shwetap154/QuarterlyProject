({
    zoetisTerritoryUpdate : function(component, event, helper) {
        var action = component.get("c.territoryUpdate");
        action.setParams({ terrIdList : component.get("v.strTerrIds") });
        action.setCallback(this, function(response){
            var state = response.getState();

            if (state === "SUCCESS") {
                helper.updateCustomTerrAssignedFlag(component, event, helper);
    ...
    updateCustomTerrAssignedFlag : function(component, event, helper) {
        var action = component.get("c.updateAssignedFlag");
        action.setCallback(this, function(response){
            var state = response.getState();
    ...
    doRedirect: function (component, event, helper, pass, error) {
        ...
        if (!pass){
            //var error = 'Update of custom territory assigned flag failed.';
