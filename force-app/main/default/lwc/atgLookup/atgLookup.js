...
export default class Lookup extends LightningElement {
    ...
    handleClearSelection() {
        const recordId = this._curSelection[0].id;
        console.log('current lookup selection before clear', recordId);
        this._curSelection = [];
        this._isDirty = true;
        // Notify parent components that selection has changed
        this.dispatchSelectionChange();
        this.dispatchEvent(new CustomEvent('selectionremoved', { detail: recordId}));
    }
