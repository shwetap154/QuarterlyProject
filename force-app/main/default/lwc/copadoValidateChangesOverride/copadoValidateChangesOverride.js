/**
 * @description       : JS Class for Manage Validate Changes to invoke the main Override JS
...
export default class CopadoValidateChangesOverride extends LightningElement {
